...
def model_load(IMG_SHAPE=(224, 224, 3), class_num=120):
    ...
    #base_model.trainable = True  # 将主干的特征提取网络参数进行冻结
...
def show_loss_and_acc(history):
    ...
    plt.xlabel('epoch')
    plt.savefig('result_images/MobileNetV2_80layers_epoch30.png', dpi=100)
...
def train(epochs):
    ...
    model.save("models/MobileNetV2_80layers_epoch30.h5")
